...
public class Main {
    public void main(String[] args) {
        ...
        EmployeeReportService report = new EmployeeReportService(exporter, formatter);
        report.createReport(employees, "legends.csv");

        EmployeeReportService reportDev = new EmployeeReportService(exporter2, formatter);
